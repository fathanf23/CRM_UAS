...
<div class="row">
    ...
    <div>
        <a href="{{url('/admin/transaksi/create')}}" class="btn bg-gradient-warning"><i class="fas fa-plus">
    ...
    <table class="table align-items-center mb-0" id="example">
        ...
        <tfoot>
            <tr>
                ...
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Harga Total + Diskon</th>
        ...
        <tbody>
            <tr>
                ...
                <td>
                <a href="{{ url('admin/transaksi/delete/' .$t->id) }}" class="btn btn-md btn-danger px-2" data-bs-toggle="modal" data-bs-target="#exampleModal{{$t->id}}">
                                ...
                                <a href="{{url('admin/transaksi/edit/'.$t->id)}}" class="btn btn-md btn-primary"><i
